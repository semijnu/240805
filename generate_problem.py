...
범위는 if문이야 형식에 맞게 제공해줘~
예시로 사용자로부터 정수 n을 입력 받아서 그 정수값의 팩토리얼을 구하는 프로그램을 작성하세요. 팩토리얼이란 자연수 n에 대해서 1부터 n까지의 모든 자연수를 곱하는 것을 합니다. 예를 들어, 5의 팩토리얼은 5 x 4 x 3 x 2 x 1 = 120입니다.
이런식으로 작성해줬으면 좋겠어!
그리고 문제 설명할때 입력 출력도 예시로 제공해줘! 테스트케이스 처럼! 한개만!
---
